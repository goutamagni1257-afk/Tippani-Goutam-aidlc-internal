...
`ai_proficient` project track. The implementation is based on the audit-log service baseline; track-specific requirements should be added here when provided.
